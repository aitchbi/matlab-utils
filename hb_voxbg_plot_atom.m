% Based on ml_plot_atom_box.m by Martin Larsson, extended on multiple
% fronts, e.g.:
...
% 4. added option to plot atoms in a format adapted to FSLEYES.
% 5. added option to plot atoms in the form of contours instead of imagesc.
...
function [axa,axu,abb] = hb_voxbg_plot_atom(G,node,plane,varargin)
    ...
    if isempty(opts.axis_atom)
        ...
        switch Nplots
            case 1
                set(hf,'Position',[10 10 400 300]);
            case 2
                set(hf,'Position',[10 10 700 300]);
            case 3
                set(hf,'Position',[10 10 1000 300]);
        end
